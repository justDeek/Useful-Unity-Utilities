...
namespace HutongGames.PlayMaker.Actions
{
	...
	public class GDEFindItemsByValue2 : FsmStateAction
	{
		[ActionSection("Input")]
		...
		public override void OnEnter()
		{
			...
			foreach (var tmp in tmpValues)
			{
				...
				{
					value.UpdateValue();
					if(fieldValue.GetType() != value.GetType()) UnityEngine.Debug.LogError("Given value type doesn't match result type!");
					if (fieldValue != value.GetValue()) continue;
