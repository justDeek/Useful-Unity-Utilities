...
public class DebugFSM : MonoBehaviour
{
	...
	[HideInInspector] public bool debugVariables;
	[HideInInspector] public int traceBackAmount = 3;
	[HideInInspector] public int startFrom;
	...
	public void OnGUI()
	{
		...
		if(targetFSM == null || targetFSM.gameObject == null)
		{
			GUI.Label(labelRect, "No FSM component specified on" + ": "
								 + this.gameObject.name, _guiStyle); //alt. if LittleHelpers got implemented: .GetGameObjectPath(true)
